...
alias cmake='cmake -D CMAKE_C_COMPILER=/opt/gcc8.2/install/bin/gcc -D CMAKE_CXX_COMPILER=/opt/gcc8.2/install/bin/g++'

#===========emacs=============
export EMACSSYS=/opt/emacs26.1/install
export PATH=$EMACSSYS/bin:$PATH

#===========gcc===============
export GCCSYS=/opt/gcc8.2/install
export PATH=$GCCSYS/bin:$PATH
export LD_LIBRARY_PATH=$GCCSYS/lib64:$LD_LIBRARY_PATH
export CPLUS_INCLUDE_PATH=$GCCSYS/include/c++/8.2.0:$CPLUS_INCLUDE_PATH
export CPLUS_INCLUDE_PATH=$GCCSYS/include:$CPLUS_INCLUDE_PATH

#==========qt=================
export QTSYS=/opt/qt5.10/install
...
#=========cmake===============
export CMAKESYS=/opt/cmake3.13/install
...
#==========ffmpeg=============
export FFMPEGSYS=/opt/ffmpeg4.1/install
...
#=========python3=============
export PYTHON3SYS=/opt/python3.7/install
...
#==========boost==============
export BOOSTSYS=/opt/boost1.68/install
export LD_LIBRARY_PATH=$BOOSTSYS/lib:$LD_LIBRARY_PATH

#===========root==============
export ROOTSYS=/opt/root6.14/install
...
#===========texlive===========
export TEXLIVESYS=/opt/texlive2018/install
...
# #============clang=============
# export CLANGSYS=/opt/llvm7.0/install
...
#==============htop==================
export HTOPSYS=/opt/htop2.2/install
...
#=============wechat===============
export PATH=/opt/wechat/electronic-wechat-linux-x64:$PATH

#===============乱78遭=============
export LD_LIBRARY_PATH=/usr/bin/x86_64-linux-gnu:$LD_LIBRARY_PATH
export CPLUS_INCLUDE_PATH=/usr/include/x86_64-linux-gnu:$CPLUS_INCLUDE_PATH

#==============pythia==============
export PYTHIA8SYS=/opt/pythia/install
export LD_LIBRARY_PATH=$PYTHIA8SYS/lib:$LD_LIBRARY_PATH

#===========code-blocks============
export CODEBLOCKSSYS=/opt/codeblock/install
export PATH=$CODEBLOCKSSYS/bin:$PATH
export LD_LIBRARY_PATH=$CODEBLOCKSSYS/lib:$LD_LIBRARY_PATH
